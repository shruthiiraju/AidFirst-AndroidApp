...
public class AudioPlayer {
        ...
        new Thread() {
          ...
          public void run() {
            ...
            try {
              ...
              Log.e("AUDIOPLAYER", "Exception with playing stream", e);
            } finally {
              stopInternal();
              audioTrack.release();
              onFinish();
  ...
  private void stopInternal() {
    ...
    try {
      ...
      Log.e("AUDIPLAYER", "Failed to close input stream", e);
    }
  }
  ...
  public void stop() {
    ...
    try {
      ...
      Log.e("AUDIOPLAYER", "Interrupted while joining AudioRecorder thread", e);
