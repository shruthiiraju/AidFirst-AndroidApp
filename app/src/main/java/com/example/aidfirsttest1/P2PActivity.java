...
public class P2PActivity extends ConnectionsActivity {
    ...
    private byte[] arraymine = {12,3,23,3,1,23,123,3,123};
    InputStream targetStream = new ByteArrayInputStream(arraymine);
    ...
    protected void onEndpointConnected(Endpoint endpoint) {
        ...
        locationTrack = new LocationTrack(P2PActivity.this);
        if (locationTrack.canGetLocation()) {
            ...
            Payload bytesPayload = Payload.fromBytes(location.getBytes());
            send(bytesPayload);
    ...
    private void updateTextView(TextView textView, State state) {
        switch (state) {
            case SEARCHING:
                ...
                textView.setText("Looking for Heroes nearby...");
                break;
            case CONNECTED:
                textView.setBackgroundColor(mConnectedColor);
                textView.setText("Connected to Hero");
                break;
            case DISCOVERED:
                textView.setBackgroundResource(R.color.state_searching);
                textView.setText("Heroes discovered... Waiting to connect.");
                break;
            case DISCONNECTED:
                textView.setBackgroundResource(R.color.colorPrimary);
                textView.setText("Hero Disconnected");
            default:
    ...
    protected void onReceive(Endpoint endpoint, Payload payload) {
        if (payload.getType() == Payload.Type.STREAM) {
            ...
            try {
                Log.e("CAche", getCacheDir().toString());
